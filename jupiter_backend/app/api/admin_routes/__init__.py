...
# REMOVED: model_assignments_router import that was causing the error
# protected_admin_api.include_router(model_assignments_router, tags=["Admin Model Assignments"])
